...
valType="check"
remoteUrl="/admin.php/dangyuantiku/chktitle.shtml?id=<?php echo $model["id"];?>"
		...
		var h = 400;
		 BUI.use('bui/overlay',function(Overlay){
	         dialog2 = new Overlay.Dialog({
	           ...
	           height:h,
	           //配置文本
	           bodyContent:'<iframe id="ifr_additem" name="ifr_additem" src="<?php echo site_url("dangyuantiku/edititem")?>?id='+id+'" width="'+(w-10)+'"  height="'+(h-60)+'" frameborder="0" marginwidth="0" marginheight="0"  ></iframe>',
	           buttons:[
...
function getlist(){
	...
	//读数据库
	var ajax_url = "<?php echo site_url("dangyuantiku/getitem")?>?id=<?php echo $model["id"];?>";
	$.ajax({
        type: "get",
        url: ajax_url,
        data: '',
...
function delitem(id){
	var ajax_url = "<?php echo site_url("dangyuantiku/delitem")?>?id="+id;
	$.ajax({
        type: "get",
        url: ajax_url,
        data: '',
