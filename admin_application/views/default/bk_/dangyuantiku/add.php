...
value="" required="true" 
valType="check"
remoteUrl="/admin.php/dangyuantiku/chktitle.shtml?id=0"
		...
		var h = 400;
		 BUI.use('bui/overlay',function(Overlay){
	         dialog2 = new Overlay.Dialog({
	           ...
	           height:h,
	           //配置文本
	           bodyContent:'<iframe id="ifr_additem" name="ifr_additem" src="<?php echo site_url("dangyuantiku/additem")?>?item='+item+'&i='+i+'" width="'+(w-10)+'"  height="'+(h-60)+'" frameborder="0" marginwidth="0" marginheight="0"  ></iframe>',
	           buttons:[
