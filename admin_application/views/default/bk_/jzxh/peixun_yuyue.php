  ...
  <tbody id="result_">
           ...
           <?php
            ...
            foreach($list as $v){
            	...
            	echo $v["check_status"]=="1"?"<span style='color:red'>未处理</span>":"";
            	echo $v["check_status"]=="2"?"<span style='color:blue'>已处理</span>":"";
   				echo "</td>";
            	echo "<td>".$v["linkman"];
            	...
            	echo "<td>".$v["tel"]."</td>";
            	echo "<td>";
            	echo "预约项目：".$v["gongzhong_title"]."";
            	echo $v["beizhu"]!=""?"<br/>补充说明：".$v["beizhu"]:"";
            	...
            	echo "<td>".date("Y-m-d H:i",strtotime($v["create_time"]))."</td>";                        	            	             
            	echo "</tr>";
            	echo "\n";
            }
            ?>  
...
function godel(){
	...
	if(ids==""){		
		...
		var ajax_url = "<?php echo site_url("user/peixun_yuyue_del");?>?idlist="+$("#selid").val();
		//var url = "<?php echo $_SERVER['REQUEST_URI'];?>";
		var url = "<?php echo base_url();?>gl.php/user/peixun_yuyue.shtml";
...
function goset_check(yesorno){
	...
	if(ids==""){		
		...
		var ajax_url = "<?php echo site_url("user/peixun_yuyue_set_chuli");?>?check="+yesorno+"&idlist="+$("#selid").val();
		//var url = "<?php echo $_SERVER['REQUEST_URI'];?>";
		var url = "<?php echo base_url();?>gl.php/user/peixun_yuyue.shtml";
		parent.parent.my_confirm(
				"确认操作？",
