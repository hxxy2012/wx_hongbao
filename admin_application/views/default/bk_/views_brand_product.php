    ...
    <body class="definewidth">
        <div class="form-inline definewidth m20" >
            ...
            <ul class="ul_head">
                ...
                <li>
                    <form method="get" >
                        <input type="text"  name="search_title" id="search_title" class="abc input-default" placeholder="标题" style="width:150px; height:26px;" value="<?php echo isset($search_val['search_title'])?$search_val['search_title']:''; ?>"> 
            ...
            <tbody id="result_">
               ...
               $i=$total;
                foreach ($list as $v) {
                    ...
                    echo "<td>  <a class='page-action ' data-href='".site_url('brand_product/edit')."?id=".$v["guid"]."&brand_id={$brand_id}' href=\"#\" data-id='".__CLASS__.$v["guid"]."' title=\"编辑".$v["pro_name"]."\">编辑</a>";
...
<script>
            function godel() {
                ...
                if (ids == "") {
                    ...
                    var ajax_url = "<?php echo site_url("brand_product/del"); ?>?idlist=" + $("#selid").val();
