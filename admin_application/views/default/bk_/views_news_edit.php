...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <td><input type="file" name="image" />
			<img src="<?php echo $this->v_upload_path."/{$info['image']}"?>" >
		</td>
    </tr>		
     <tr>
        ...
        <td>
         <select name="type" style="width:300px" onchange="_typename()" id="type">
			<option value="">请选择</option>
         	...
         	?>
         	<option value="<?php echo $c_v['id'] ; ?>" <?php if($c_v['id'] == $info['type']){echo "selected";}?>><?php echo $c_v['html'];?><?php echo $c_v['typename']  ; ?></option>
         	<?php 
