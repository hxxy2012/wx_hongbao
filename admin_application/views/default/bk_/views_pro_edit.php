...
<table class="table table-bordered table-hover m10">
    ...
    <tr>
        ...
        <td><input type="text" style="width:300px;" name="title" id="title" required errMsg="请输入项目名称" tip="请输入项目名称" value="<?php echo $info["title"];?>"/></td>
    </tr>
    <tr>
...
required errMsg="请选择开始时间" tip="请选择开始时间" value="<?php echo date("Y-m-d H:i:s",$info["jihua_start_time"]);?>"
>
至
...
required errMsg="请选择结束时间" tip="请选择结束时间" value="<?php echo date("Y-m-d H:i:s",$info["jihua_end_time"]);?>"
>
        </td>
    </tr> 	
    <tr>
...
　<span style="color:#666666">通过的项目才能被其他人看见</span>
    ...
    <tr>
        ...
        <td>
<textarea style="width:100%; height:150px" id="content" name="content" placeholder="描述">
