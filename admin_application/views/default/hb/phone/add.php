...
<table class="table table-bordered table-hover m10">
    ...
    <tr>
        ...
        <td>
          ...
          <textarea name="tel" id="tel" style="width:270px;" cols="30" rows="5" required></textarea>
          &nbsp;<span class="hint">（多个手机号码的以英文逗号分隔‘,’，例如：13532154258,15905245596）</span>
        </td>
    </tr>
    <tr>
        <td class="tableleft">备注</td>
        <td>
          <textarea name="beizhu" id="beizhu" style="width:270px;" cols="30" rows="5"></textarea>
        </td>
    </tr>
    <tr>
