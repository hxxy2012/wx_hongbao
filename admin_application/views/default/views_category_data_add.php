...
<body>
<form action="<?php echo site_url("category_data/add");?>" method="post" class="definewidth" id="myform_add">
...
<table class="table table-bordered table-hover definewidth m10">
    <tr>
        <td width="10%" class="tableleft">名称
                <br/>
         一行一个

        </td>
        <td>
        <!--input type="text" id="name" name="name" placeholder="名称" required/-->
       
<textarea name="name" style="width:90%; height:50px;" required>
</textarea>        
        </td>
    </tr>
     <tr>
