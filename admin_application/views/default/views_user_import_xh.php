...
<div class="form-inline definewidth m20" >
   ...
   <a href="/data/download/exceltpl/xhjgtpl.xls">下载excel模板</a>&nbsp;&nbsp;
</div>

<form action="<?php echo site_url("user/import_xh");?>" enctype="multipart/form-data" method="post" class="definewidth m2"  name="myform" id="myform">
<input type="hidden" name="action" value="doimport_xh">
