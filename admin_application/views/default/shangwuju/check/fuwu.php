...
<table class="table table-bordered table-hover m10">
    ...
    <tr >
        <td class="tableleft">电子商务服务项目类型</td>
        <td colspan="3"><?php
foreach($project_type as $k=>$v){
	echo "<input type='checkbox' disabled ";
	
	if( in_array($v["id"],explode(",",$model2["project_type"])) ){
		echo " checked ";
	}	
	echo " />";
	echo $v["name"];
...
?></td>
    ...
    <tr>
      <td class="tableleft">服务企业数量（家）</td>
      <td><?php echo $model2["qiyeshu"];?></td>
      <td class="tableleft">年营业收入（万元）</td>
