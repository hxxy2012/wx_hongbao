...
<table class="table table-bordered table-hover m10">
    ...
    <tr >
        <td class="tableleft">交易平台名称</td>
        <td colspan="3"><?php echo $model2["title"];?></td>
    </tr>

    <tr>
      <td class="tableleft">增值电信业务经营许可证号</td>
      <td><?php echo $model2["xukezheng"];?></td>
      <td class="tableleft">网站ICP备案证号</td>
      <td ><?php echo $model2["icp"];?></td>
    </tr>
    <tr>
      <td class="tableleft">平台销售的主要产品类别</td>
      <td colspan="3">
<?php
foreach($protype_list as $v){
	echo $v["name"]." ";	
}
?>      
      </td>
...
foreach($yuanqu_chanquan as $v){
	...
	if($v["id"] == $model2["chanquan"] ){
		echo " checked ";
	}	
	echo " />";
	echo $v["name"];
	if($model2["chanquan"]=="45172"){
		//其他
		echo "(";
		echo $model2["chanquan_other"];		
		echo ")";	
	}
	echo "&nbsp;&nbsp;";
}
?>      
    ...
    <tr>
      ...
      <td><?php echo $model2["uv"];?></td>
      <td class="tableleft">平台年度总成交额（UV）</td>
      <td ><?php echo $model2["chengjiao"];?></td>
    </tr> 
    <tr>
