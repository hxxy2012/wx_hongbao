...
<form action="<?php echo site_url("Swj_businesstracking/edit");?>" method="post"  enctype="multipart/form-data" class="definewidth m2"  name="myform" id="myform">
...
<table class="table table-bordered table-hover m10">
    ...
    <tr>
        ...
        <script>
            ...
            $('#buttondel').click(function(){
                $.ajax({
                 type: "POST",
                 url: "<?php echo site_url("Swj_businesstracking/ajax_del_pic");?>",
                 data: {id:<?php echo $id;?>},
    ...
    <tr>
        ...
        <td><input type="text" name="jingbanren" id="jingbanren" required value="<?php echo $jingbanren?>" tip="请输入经办人"/></td>
    </tr>
    
     <tr>
        <td class="tableleft">完成日期</td>
        <td><input type="text" name="complete_date" id="complete_date" value="<?php echo $complete_date?>"  onclick="laydate({istime: false, format: 'YYYY-MM-DD'})"  required="true"   placeholder="请输入完成日期"  tip="请输入完成日期"/></td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <textarea style="width:300px; height:150px" id="content" name="content" placeholder="描述"><?php echo htmlspecialchars($content)?></textarea>
        </td>
    </tr>
    <tr>
