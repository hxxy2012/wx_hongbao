...
<div class="form-inline definewidth m20" >
   <a  class="btn btn-primary" id="addnew" href="<?php echo site_url("Swj_file_manager/index");?>">文件列表</a>
</div>
<form action="<?php echo site_url("Swj_file_manager/add");?>" enctype="multipart/form-data"  method="post" class="definewidth m2"  name="myform" id="myform">
<input type="hidden" name="action" value="doadd">
<table class="table table-bordered table-hover m10">

    <tr>
        <td class="tableleft">文件名称</td>
        <td><input type="text" name="name" id="name" required="true"  tip="请输入文件名称"/></td>
    </tr>
     <tr>
