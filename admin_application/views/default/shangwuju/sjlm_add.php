...
<form action="<?php echo site_url("swj_sjsbgl/add");?>" method="post" class="definewidth m2"  name="myform" id="myform">
<input type="hidden" name="action" value="doadd">
<table class="table table-bordered table-hover m10">

    <tr>
        <td class="tableleft">类目名称</td>
        <td><input type="text" name="name" id="name" required="true"  tip="请输入类目名称"/></td>
    </tr>
    <tr>
        <td class="tableleft">可视权限</td>
        <td>
            <input type="radio" name="isshow" value="1"/> 公开
            <input type="radio" name="isshow" value="0" checked/> 不公开&nbsp;&nbsp;
    ...
    <tr>
     ...
     <tr>
        ...
        <td>
            <input type="text" name="sb_stime" id="sb_stime" required="true" value="" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" placeholder="开始时间"/>——
            <input type="text" name="sb_etime" id="sb_etime" required="true" value="" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" placeholder="结束时间"/>
        </td>
    </tr>
     <tr>
        <td class="tableleft">审核时段</td>
        <td>
            <input type="text" name="sh_stime" id="sh_stime" required="true" value="" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" placeholder="开始时间"/>——
            <input type="text" name="sh_etime" id="sh_etime" required="true" value="" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" placeholder="结束时间"/>
        </td>
    </tr>
    <tr>
