...
<form action="<?php echo site_url("swj_xxbagl/add");?>" method="post" class="definewidth m2"  name="myform" id="myform">
<input type="hidden" name="action" value="doadd">
<table class="table table-bordered table-hover m10">

    <tr>
        <td class="tableleft">类目名称</td>
        <td><input type="text" name="name" id="name" required  tip="请输入类目名称"/></td>
    </tr>
    <tr style="display:none;">
        ...
        <td>离活动开始<input type="text"onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"
         style="width:68px;" name="latest" id="latest" required tip="请输入最迟的备案时间" value="<?php echo $config["cfg_beian_day"];?>"/>天前</td>
    </tr>
    <tr>
