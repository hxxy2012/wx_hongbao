  ...
  <tbody id="result_">
           ...
           <?php
            ...
            foreach($list as $v){
				...
				echo "<a class='page-action icon-list' data-href='".site_url('user/reg_edit_check_xh_details')."?id=".$v["id"]."&backurl=".urlencode(get_url())."' href=\"#\" data-id='xhcheckuserlist_".$v["id"]."' id='xhcheckuserlist_".$v["id"]."' title=\"编号".$v["id"]."协会信息\"></a>";	
...
function godel(){
	...
	if(ids==""){		
		...
		var ajax_url = "<?php echo site_url("user/set_check_xh_del");?>?idlist="+$("#selid").val();
		//var url = "<?php echo $_SERVER['REQUEST_URI'];?>";
		var url = "<?php echo base_url();?>gl.php/user/reg_edit_check_xh.shtml";
