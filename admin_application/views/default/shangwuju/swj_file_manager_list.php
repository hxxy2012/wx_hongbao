     ...
     //  async:false,
      ...
      if(msg.resultcode<0){
        ...
        for(var i in list){
          ...
          shtml+='<td>';
        shtml+='   <a target="_blank" href="<?php echo site_url('Swj_file_manager/download');?>?id='+list[i].id+'" class="icon-download"></a>&nbsp;&nbsp;';
        shtml+='   <a href="<?php echo site_url('Swj_file_manager/edit');?>?id='+list[i].id+'" class="icon-edit"></a>&nbsp;&nbsp;';
