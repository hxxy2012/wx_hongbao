...
<form action="<?php echo site_url("swj_xxbasp/check?caozuo=".$caozuo);?>" method="post" class="definewidth m2"  name="myform" id="myform">
...
<?php if($audit_status<=10||$audit_status==30) {?>
<table class="table table-bordered table-hover m10">
        ...
        <td>
            ...
            foreach ($file as $key => $value) {
                ...
                if (in_array($lastname, $pic_arr)) {//为图片类型，输出图片
                    echo "<a href='$filesrc'><img src='$filesrc' style='width:80px;height:50px;'/></a>";
                } else {
                    echo "<a href='$filesrc'>$title</a>";
                }
            }*/?>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <textarea style="width:100%; height:150px" id="beizhu" name="beizhu" placeholder="描述"><?php echo htmlspecialchars($plan_audit)?></textarea>
        </td>
    </tr>
<!--     <tr>
...
<?php } else {?>
    ...
    <tr>
        ...
        <td>
            <textarea style="width:100%; height:150px" id="beizhu" name="beizhu" placeholder="审核意见"><?php echo htmlspecialchars($second_audit)?></textarea>
        </td>
    </tr>
     <tr>
        <td class="tableleft">报销金额</td>
        <td>
            <input type="text" name="baoxiao_price" onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')" value="<?php echo $baoxiao_price;?>">
        </td>
    </tr>
<!--     <tr>
    <td class="tableleft"></td>
...
KindEditor.ready(function(K) {
       ...
       var isfirst = <?php if($audit_status<=10||$audit_status==30) echo '1';else echo '2'?>;
       if (isfirst == '1') {
