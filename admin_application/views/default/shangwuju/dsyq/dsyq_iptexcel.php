...
<div class="form-inline definewidth m20" >
   ...
   <a href="/data/download/exceltpl/dsyqtpl.xls">下载excel模板</a>&nbsp;&nbsp;
</div>

<form action="<?php echo site_url("swj_dsyq/importExcel");?>" enctype="multipart/form-data" method="post" class="definewidth m2"  name="myform" id="myform">
<input type="hidden" name="action" value="doIptExcel">
