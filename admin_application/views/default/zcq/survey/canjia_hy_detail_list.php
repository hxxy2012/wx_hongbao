...
关键字：
    ...
    placeholder="问题名称" 
    value="<?php if(isset($search_val['wtname'])) echo $search_val['wtname'];?>"
    style="width:200px;"
    />
    <input type="hidden" name='diaocha_id' value="<?php if(isset($search_val['diaocha_id'])) echo $search_val['diaocha_id'];?>">
    <input type="hidden" name='linkname' value="<?php if(isset($search_val['linkname'])) echo $search_val['linkname'];?>">
    <input type="hidden" name='create_userid' value="<?php if(isset($search_val['create_userid'])) echo $search_val['create_userid'];?>">
	<input type="hidden" name="linkname" value="<?php if(isset($search_val['linkname'])) echo $search_val['linkname']; ?>"/>
  ...
  <tbody id="result_">
           ...
           <?php
            ...
            foreach($list as $v){
            	...
            	echo "<td>".$v["id"]."</td>";
            	echo "<td>".$v["wtname"]. $v['title_add'] ."</td>";
            	echo "<td>".$v["hd"]."</td>";
            	echo "<td>".$v["ip"]."</td>";
