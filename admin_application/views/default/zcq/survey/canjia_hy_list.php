...
关键字：
    ...
    placeholder="联系人" 
    value="<?php if(isset($search_val['linkname'])) echo $search_val['linkname'];?>"
    style="width:200px;"
    />
  ...
  <tbody id="result_">
           ...
           <?php
            ...
            foreach($list as $v){
            	...
            	echo "<td><a class='page-action icon-list-alt' data-href='".site_url("zcq_survey/hy_cj_detail")."?backurl=".(urlencode(get_url()))."&linkname=".$v["linkname"]."&diaocha_id=".$search_val['diaocha_id']."' href=\"#\" data-id='open_hy_cj_detail_".$v["id"]."' id='open_hy_cj_detail_".$v["id"]."' title=\"查看".$v["linkname"]."的调查结果\"></a>&nbsp;</td>";                         	            	             	
            	echo "</tr>";
            	echo "\n";
            }
            ?>  
