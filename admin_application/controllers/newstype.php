...
class Newstype extends MY_Controller{
	...
	private function doadd(){	
		$typename = dowith_sql(daddslashes(html_escape(strip_tags($this->input->get_post("typename")))));
	...
	private function doedit(){
		...
		$sql_edit = "UPDATE `{$this->table_}extra_newstype` SET status = '{$status}',typename = '{$typename}',disorder = '{$disorder}',seotitle='{$seotitle}',keywords = '{$keywords}' ,description = '{$description}'   where id = '{$id}'";
