<?php
class M_website_model_zuixindongtai extends M_common {
	private $table = "website_model_zuixindongtai";
	private $tablename = "动态副表";
	function M_website_model_zuixindongtai(){
		parent::__construct();	
