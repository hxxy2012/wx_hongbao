 ...
 */
class m_zcq_pro_guanli extends M_common
{
    public $table = "zcq_pro_guanli";
    ...
    public function getList($pageindex, $pagesize, $search)//$admintype
    {
        ...
        foreach ($search as $k => $v) {
            if ($k == "name") {
                $where .= " and ( t1.companyname like '%{$v}%' or t1.companyname2 like '%{$v}%' or  t1.linkman like '%{$v}%' or t1.tel like '%{$v}%' or t1.mobile like '%{$v}%')";
