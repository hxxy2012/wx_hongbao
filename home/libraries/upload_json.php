...
if (empty($_FILES) === false) {
	...
	//取实际图片宽度
	$image_size   =   getimagesize(realpath(".".str_replace(base_url(),"",$file_url)));
	//生成大中小三张缩略图	
	$config['image_library'] = 'gd2';
	$width_arr[] = $this->sysconfig->GetConfig("cfg_thumb_small");
	$width_arr[] = $this->sysconfig->GetConfig("cfg_thumb_mid");
	$width_arr[] = $this->sysconfig->GetConfig("cfg_thumb_big");
	
	$height_arr[] = $this->sysconfig->GetConfig("cfg_thumb_small_height");
	$height_arr[] = $this->sysconfig->GetConfig("cfg_thumb_mid_height");
	$height_arr[] = $this->sysconfig->GetConfig("cfg_thumb_big_height");
