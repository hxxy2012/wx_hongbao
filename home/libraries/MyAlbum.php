...
//生成相册
class MyAlbum extends CI_Model{
...
*/
	...
	function DelAlbumOnePic(picname){
					$.ajax(
					{
						url: \"/admin.php/Website_category/AlbumDelPic.shtml\",
						type:\"post\",
		 ...
		 BUI.use(['bui/overlay','bui/mask'],function(Overlay){					
		        var dialog = new Overlay.Dialog({
				    ...
				    success : function(){		
						...
						$.ajax(
						{
							url: \"/admin.php/Website_category/AlbumSavePic.shtml?rnd=\"+Math.random(),
		            ...
		            loader : {
		              url : '/admin.php/Website_category/AlbumSetPic.shtml',
