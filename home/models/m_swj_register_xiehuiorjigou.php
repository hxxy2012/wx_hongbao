<?php
class M_swj_register_xiehuiorjigou extends M_common {
	private $table = "swj_register_xiehuiorjigou";
	private $tablename = "电商企业资料";
	function M_swj_register_xiehuiorjigou(){
		parent::__construct();	
