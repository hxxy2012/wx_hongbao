...
class m_zcq_duiwaitouzi extends M_common
{
    ...
    public function getList($pageindex, $pagesize, $search,$orderby = array())//$admintype
    {
        ...
        $sql = "select t1.* from $table_join WHERE {$where} {$orderby_str} limit {$limit}";
     ...
     * @return array
     */
    public function getList_qy($pageindex, $pagesize, $search,$orderby = array()){
        //分页
        $this->load->library("common_page");
