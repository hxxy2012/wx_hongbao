    ...
    <div>
        <div class="home_list">
            <div class="home_carousel_figure">
                ...
                <ul>
                    <?php foreach ($adv as $key => $value): ?>
                        <li><a href="<?php echo $value['pic_url']?>" target="_blank">
                            <img src="/<?php echo $value['pic']?>" alt="<?php echo $value['pic_des']?>"/>
            ...
            <div class="home_news_list">
                <h3>工作状态<a href="<?php echo site_url('home/transfer').'?pid=38&cid=48';?>">查看更多</a></h3>
                <ul>
                    <?php foreach ($gzzt as $key => $value): ?>
                        <li>
                            <p>
                                <span class="news_day"><?php echo date('d',$value['post'])?></span>
                                <span><?php echo date('m',$value['post'])?></span>
                            </p>
