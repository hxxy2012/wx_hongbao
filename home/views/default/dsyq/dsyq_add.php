...
<table class="table table-bordered table-hover m10">
    <tr>
        ...
        <td>
            <input type="text" name="name" style="width:333px;" value="" required/>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" name="jymj" value="" required 
    ...
    <tr>
        ...
        <td>
           <input type="text" required onkeyup="this.value=this.value.replace(/\D/g,'')"   onafterpaste="this.value=this.value.replace(/\D/g,'')" name="jzqynum" value="">&nbsp;个
        </td>
    </tr>
    <tr>
        <td class="tableleft">产权情况<span class="hint">*</span></td>
        <td>
           <input type="radio" class="cqcondition" name="cqcondition" value="1">企业所有&nbsp;
           <input type="radio" class="cqcondition" name="cqcondition" value="2">企业租赁&nbsp;
           <span class="cq_year_box" style="display:none;"><input type="text" style="margin-bottom:0;" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" name="cq_year" id="cq_year" value="">&nbsp;年</span>
        </td>
    </tr>
     <tr>
        <td class="tableleft">建筑面积</td>
        <td>
            <input type="text" name="jzmj" value=""
            onkeyup="if(isNaN(value))execCommand('undo')"  onafterpaste="if(isNaN(value))execCommand('undo')"/>&nbsp;平方米<span class="tips_lk">(保留两位小数)</span>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <input type="text" name="zdmj" value=""
            onkeyup="if(isNaN(value))execCommand('undo')"  onafterpaste="if(isNaN(value))execCommand('undo')"/>&nbsp;平方米<span class="tips_lk">(保留两位小数)</span>
        </td>
    </tr>
     <tr>
        ...
        <td>
           <input type="text" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" name="dsqynum" value="">&nbsp;个
        </td>
    </tr>
    <tr>
        <td class="tableleft">当地扶持政策</td>
        <td>
           <input type="text" name="haspolicy" style="width:333px;" value="">&nbsp;<span class="tips_lk">(何年何月获得当地扶持政策,无则不填)</span>
        </td>
    </tr>
    <tr>
        <td class="tableleft">所获称号</td>
        <td>
           <input type="text" name="chenghao" style="width:333px;" value="">&nbsp;<span class="tips_lk">(何年何月获得市级、省级、国家级称号,无则不填)</span>
        </td>
    </tr>
    <tr>
        <td class="tableleft">联系人姓名</td>
        <td>
           <input type="text" name="linkman_name" value="">
        </td>
    </tr>
    <tr>
        <td class="tableleft">联系人电话</td>
        <td>
           <input type="text" name="linkman_phone" value="">
        </td>
    </tr>
    <tr>
        <td class="tableleft">联系人职务</td>
        <td>
           <input type="text" name="linkman_work" value="">
        </td>
    </tr>
    <tr>
        <td class="tableleft">园区或基地地址</td>
        <td>
           <input type="text" name="yq_addr" style="width:333px;" value="">
        </td>
    </tr>
    <tr>
        <td class="tableleft">园区或基地官方网站</td>
        <td>
           <input type="text" name="yq_website" style="width:333px;" value="">
        </td>
    </tr>
    <tr>
        <td class="tableleft">园区或基地简介</td>
        <td>
           <textarea style="width:100%; height:150px" id="yq_describe" name="yq_describe" placeholder="简介"></textarea>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
           <textarea style="width:300px; height:100px;" id="beizhu" name="beizhu" placeholder="备注"></textarea>
        </td>
    </tr>
</table>
