...
<table class="table table-bordered table-hover m10">
    <tr>
        <td class="tableleft" style="width:198px;">电子商务服务项目类型</td>
        <td>
            <?php foreach ($all_fwxmlx as $key => $value): ?>
                <input type="checkbox" name="project_type[]" style="margin-top:0;" readonly diabled 
    ...
    <tr>
        <td class="tableleft">电子商务服务项目名称</td>
        <td>
            <?php if(isset($title))echo $title;?>
        </td>
    </tr>
    <tr>
        <td class="tableleft">服务企业数量</td>
        <td>
            <?php if(isset($qiyeshu))echo $qiyeshu;?>&nbsp;家
        </td>
    </tr>
    <tr>
        <td class="tableleft">年营业收入</td>
        <td>
    ...
    <tr>
        <td class="tableleft">服务合同、服务收费票据证明材料</td>
        <td>
