        ...
        <tr>
          ...
          <td width="80%">
            ...
            <table class="m10" border="1" cellspacing="0" cellpadding="0" style="text-align:left;font-size:14px;">
                <tr >
                    <td style="width:20%;"><br>综合性服务平台名称<br><br></td>
                    <td colspan="3"><?php echo $fbmodel["title"];?></td>
                </tr>

                <tr>
                  <td><br>平台提供的服务（不得少于3项）<br><br></td>
                  <td colspan="3">
            <?php
            foreach($fbmodel['all_ptfw'] as $k=>$v){
            	echo "<input type='checkbox' style='margin:0;padding:0;border:0;margin-left:1px;' disabled ";
            	
            	if( in_array($v["id"],explode(",",$fbmodel["fuwu_type"])) ){
            		echo " checked ";
            	}	
            	echo " />";
            	echo $v["name"];
            	if($v["id"]=="45180"){
            		...
            		echo "( ";
            		echo "请列出具体情况:";
            		echo $fbmodel["fuwu_type_other"]?$fbmodel["fuwu_type_other"]:'&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
            		echo " )";	
            	}
            	echo "&nbsp;&nbsp;";		
            ...
            ?>      
                ...
                <tr>
                  <td width="100"><br>平台服务的企业数（家）<br><br></td>
                  <td width="100"><?php echo $fbmodel["qiyeshu"];?></td>
                  <td width="100">平台的营业收入（万元）</td>
