...
<?php if ($checkstatus == '-10') {?>
<div class="tips" style="margin-top:3px;">
审核时间：<?php echo date('Y-m-d H:i:s', $checktime)?>，审核不通过原因：<?php echo strip_tags($checkbeizhu);?>
</div>
<?php }?>
...
<div class="center" style="margin:0 auto;text-align:center;">
    <button class="btn btn-primary" type="button" id="btnSave">下一步</button> &nbsp;&nbsp;
